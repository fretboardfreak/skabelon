...
class SetupCommand(Command):
    ...
    def software_package(self):
        ...
        return os.path.join(self.setup_path, 'src/skabelon')
...
class UnitTestCommand(DevelopmentCommand):
    ...
    description = "Run the skabelon unittests."
    user_options = []
...
setup(
    name='skabelon',
    version='0.1',
    description='A CLI tool for the jinja2 templating engine.',
    long_description=readme(),
    url='https://github.com/fretboardfreak/skabelon.git',
    author='Curtis Sand',
    ...
    entry_points={
        'console_scripts': ['skabelon=skabelon.skabelon:main']
    },
    use_2to3=False,
    install_requires=install_requires(),
    zip_safe=True,
    include_package_data=True,
    test_suite='skabelon.tests',
    tests_require=tests_require(),
    keywords='skabelon template jinja2 cli',
    classifiers=[
        'Environment :: Console',
